...
func SetupRouter(bookController *controllers.BookController, apiKeyController *controllers.APIKeyController, apiKeyRepo *repository.APIKeyRepository, authController *controllers.AuthController) *mux.Router {
	r := mux.NewRouter()
